*******************************************************************************
/*
This do file produces country level data for user defined year 
...
collapse *25 *215 *365 *685 i gini sen mld atk* awi* ybar* (rawsum) pop [aw=pop], by(code year)
...
order code year pop w* c* p* i ybar* fgt* watt* gini sen mld atk* awi* 
...
compress
save "${intermediatedatapath}CountryData_Main`year'.dta", replace
