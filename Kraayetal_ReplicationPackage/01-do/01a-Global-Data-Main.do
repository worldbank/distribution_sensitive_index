*******************************************************************************
/*
This do file produces global data for all year used for the 
	figures and charts in Kraay r al.
Note welfare floor implemented at $0.50 across all distributions.
*/
*******************************************************************************
...
collapse *25 *215 *365 *685 i gini sen mld atk* awi* ybar* (rawsum) pop [aw=pop], by(year)
...
save "${intermediatedatapath}GlobalData_Main.dta", replace
